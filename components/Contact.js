      ...
      <div className="rounded-md shadow-md bg-[#F1F1F1] dark:bg-gray-900 p-4 md:p-10 lg:p-20 max-w-6xl mx-auto mb-20 -mt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="md:ml-4">
            ...
            <div className="social-icons flex flex-row space-x-8 justify-evenly">
              <a
          ...
          <form className="form rounded-lg bg-white dark:bg-gray-600 p-4 flex flex-col">
            <label
              htmlFor="name"
              className="text-sm text-gray-700 dark:text-gray-300 mx-4"
            >
              {" "}
              Your Name
            </label>
            <input
              type="text"
              className="font-light bg-gray-200 dark:bg-gray-700 rounded-md border focus:outline-none py-2 mt-2 px-1 mx-4 focus:ring-2 focus:border-none ring-blue-500"
              name="name"
            />
            <label
              htmlFor="email"
              className="text-sm text-gray-700 dark:text-gray-300 mx-4 mt-4"
            >
              Email
            </label>
            <input
